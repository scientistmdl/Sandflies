# Sandflies, a text-based game where players have make the right choices...
...
But during all this the Service and Clarification Group (S.C.G), were assigned by the CIA to recover a highly classified weapon which is held by a group, planning to release the toxic gas on the USA.*
